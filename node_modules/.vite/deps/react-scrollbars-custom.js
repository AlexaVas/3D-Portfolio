  ...
  "node_modules/react-draggable/build/cjs/utils/getPrefix.js"(exports) {
    ...
    function getPrefix() {
      ...
      for (let i2 = 0; i2 < prefixes.length; i2++) {
        if (browserPrefixToKey(prop, prefixes[i2]) in style2)
          return prefixes[i2];
      }
      return "";
    }
...
var require_domFns = __commonJS({
  "node_modules/react-draggable/build/cjs/utils/domFns.js"(exports) {
    ...
    function addUserSelectStyles(doc2) {
      ...
      if (doc2.body)
        addClassName(doc2.body, "react-draggable-transparent-selection");
    }
    function removeUserSelectStyles(doc2) {
      ...
      try {
        if (doc2.body)
          removeClassName(doc2.body, "react-draggable-transparent-selection");
        if (doc2.selection) {
...
function e(e2, i2, t, o) {
  for (; i2 >= t && !e2("(min-resolution: " + i2 / o + "dppx)").matches; )
    i2--;
  return i2;
}
function i(i2) {
  if (void 0 === i2 && (i2 = window), !i2)
    return 1;
  if (void 0 !== i2.devicePixelRatio)
    return i2.devicePixelRatio;
  ...
  return void 0 !== t ? void 0 !== t.devicePixelRatio ? t.devicePixelRatio : t.screen.deviceXDPI / t.screen.systemXDPI : void 0 !== i2.matchMedia ? function(i3) {
    for (var t2 = i3.matchMedia, o = 10, n = 0.1, r2 = 1, a = o, c = 0; c < 4; c++)
      o = (a = 10 * e(t2, o, n, r2)) + 9, n = a, r2 *= 10;
    return a / r2;
  }(i2) : 1;
}
    ...
    function RAFLoop2() {
      ...
      this.addTarget = function(target, silent) {
        ...
        if (!_this.targets.includes(target)) {
          ...
          if (_this.targets.length === 1 && !silent)
            _this.start();
        }
        return _this;
      };
      ...
      this.rafCallback = function() {
        ...
        for (var i2 = 0; i2 < _this.targets.length; i2++) {
          if (!_this.targets[i2]._unmounted)
            _this.targets[i2].update();
        }
        _this.animationFrameID = requestAnimationFrame(_this.rafCallback);
    ...
    function ScrollbarThumb2() {
      ...
      _this.handleOnDragStop = function(ev, data) {
        ...
        if (_this.props.onDragEnd)
          _this.props.onDragEnd(resultData);
        if (_this.element)
  ...
  function(_super) {
    ...
    function Scrollbar2(props) {
      ...
      _this.scrollTo = function(x, y) {
        if (_this.scrollerElement) {
          if (isNum(x))
            _this.scrollerElement.scrollLeft = x;
          if (isNum(y))
            _this.scrollerElement.scrollTop = y;
        }
        return _this;
      };
      _this.centerAt = function(x, y) {
        if (_this.scrollerElement) {
          if (isNum(x))
            _this.scrollerElement.scrollLeft = x - _this.scrollerElement.clientWidth / 2;
          if (isNum(y))
            _this.scrollerElement.scrollTop = y - _this.scrollerElement.clientHeight / 2;
        }
        return _this;
      };
      ...
      _this.handleTrackYClick = function(ev, values) {
        if (_this.props.trackYProps.onClick)
      ...
      if (props.onUpdate)
        _this.eventEmitter.on("update", props.onUpdate);
      if (props.onScroll)
        _this.eventEmitter.on("scroll", props.onScroll);
